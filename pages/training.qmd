...
![Credit: Gemini Robot](../media/mri_training.png){width=60% fig-align="left"}
...
![Form RO03](../resources/sops/pics/nd-hnc_layout_zones.png){fig-align="center" width=75%}

## Upcoming Trainings {#ssec:train}

Please review the schedule to select the relevant training session (and see [Level Description](#ssec:level-desc) for help determining the appropriate access Level). Register for a training session [here](https://nd.qualtrics.com/jfe/form/SV_3lcjn6KulWrGw3c){target="_blank"}.
...
This sections is designed to help with training selection. See SOP [202](../resources/sops/200_operation/2_zone_access/sop_202_zone_access.pdf){target="_blank"} for complete descriptions, restrictions, and requirements.
