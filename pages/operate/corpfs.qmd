...
![](../../media/pages/corpfs_mac_1.png){width=50% fig-align="center"}

2. Login with your Notre Dame credentials.

![](../../media/pages/corpfs_mac_2.png){width=50% fig-align="center"}

3. View directory structure in Finder.

![](../../media/pages/corpfs_mac_3.png){width=50% fig-align="center"}

# Connect: Windows

1. Log into PC workstation.

![](../../media/pages/corpfs_windows_1.jpg){width=50% fig-align="center"}

2. Navigate to PSY CorpFS (P:) > HNC.

![](../../media/pages/corpfs_windows_2.jpg){width=50% fig-align="center"}

3. Select appropriate PI directory.

![](../../media/pages/corpfs_windows_3.png){width=50% fig-align="center"}

4. View user directory structure.

![](../../media/pages/corpfs_windows_4.jpg){width=50% fig-align="center"}
