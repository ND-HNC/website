...
\begin{enumerate}
	...
	\item Close and lock the Magnet Room door.
	\item \textbf{Fire in Magnet Room}: Do not fight. For an uncontrollable fire that requires professional firefighting equipment:
	\begin{itemize}
		\item Quench the magnet (Fig. \ref{fig:button-wall-quench}).
	\end{itemize}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{quench.jpg}
	\caption{MRI system panel, with quench button (red).}
	\label{fig:button-wall-quench}
\end{figure}
