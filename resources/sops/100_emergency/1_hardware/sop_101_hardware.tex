...
\fancyfoot[C]{}
\fancyfoot[L]{ND-HNC SOP 101: v.0.3.1}
...
\begin{enumerate}
	...
	\item Evacuate Zone 2 (see SOP 302).
...
\begin{enumerate}
	...
	\begin{enumerate}
		\item If a Visitor is in the scanner, remove them immediately. If the Visitor is injured, follow injury procedures (SOP 102.5.\ref{102-ssec:injury-cons} or SOP 102.5.\ref{102-ssec:injury-uncons}).
		\item Close and lock the Magnet Room door.
		\item Move to and evacuate Zone 2 (Fig. \ref{fig:mri-zones}, see SOP 302).
		\item Call any MRI staff; MRI staff call Richard Vega (Siemens Engineer).
		\item Prepare to receive and escort SBFD.
		\item Record issue in ND-HNC Form 101: Hardware Issues Log.
	\end{enumerate}
...
\begin{enumerate}
	...
	\item Initiate Fire Evacuation (SOP 302): pull fire alarm (Fig. \ref{fig:fire-alarm}) and evacuate building.
...
\begin{enumerate}
	...
	\item Helper
	\begin{enumerate}
		\item Initiate Fire Evacuation (see SOP 302): pull fire alarm (Fig. \ref{fig:fire-alarm}) and evacuate building.
		\item \textbf{Fire in Magnet Room}: Do not fight.
		\item \textbf{Fire in Control or Equipment Room}: If possible, use the fire extinguisher in B15 to extinguish the fire (Fig. \ref{fig:fire-ext}).
		\item Call 911 to notify the South Bend Fire Department (SBFD) and say: ``We have [fire, smoke] in the MRI Center at Veldman Family Psychology Clinic, 501 North Hill Street''.
		\item Assist in receiving, escorting SBFD.
...
% Pump
\subsection{Pump: you do not hear coolant circulating.}
\label{ssec:pump}

The pumps circulate cryogens, which can be heard in B15, B17a, and B18. If the pumps are inoperative for a long enough period, the magnet may lose superconductivity and quench.
...
\begin{enumerate}
	\item Door to Magnet Room (B17a) does not release: press the emergency release button (Fig. \ref{fig:button-wall}, D); twist button clockwise to reset lock.
