...
\begin{enumerate}
	...
	\item If needed, twist the Fire Suppression trigger (Fig. \ref{fig:button-wall-con}, E).
...
\begin{figure}[H]
	...
	\caption{Control Room button wall. \textbf{A} Haskris Coolant Sounder. \textbf{B} Fire System Board. \textbf{C} Emergency Power Off. \textbf{D} Magnet Door release. \textbf{E} Fire suppression trigger. \textbf{F} Thermostat. \textbf{G} Light switch.}
