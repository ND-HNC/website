...
Electrical disruption may spark combustible materials, resulting in fire or smoking. The Magnet Room is equipped with a built-in fire suppression system which should trigger automatically, and both the Magnet Room and Control Room are equipped with fire detectors. The fire extinguisher located in B15 \textbf{IS} MR compatible.
...
\begin{enumerate}
	...
	\item For small fires, use the MR-compatible fire extinguisher located in B15 (Figs. \ref{fig:fire-ext}, \ref{fig:fire-ext-mri1}) to combat the fire only if:
	\begin{enumerate}
    ...
    \end{enumerate}
	\item Initiate Fire Evacuation (SOP 302.\ref{302-ssec:fire-evac}): pull fire alarm (Fig. \ref{fig:fire-alarm}) and evacuate building. If possible, lock the door to the Magnet Room before leaving Zone 3.
	\item Call any MRI staff; MRI staff call Richard Vega (Siemens Engineer).
	\item Prepare to receive and escort SBFD.
	\item Record issue in ND-HNC Form LG01: Hardware Issues.
\end{enumerate}
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\item You are trained to use the fire extinguisher.
		\end{enumerate}
		\item Follow Fire Evacuation procedures. If possible, lock the door to the Magnet Room before leaving Zone 3.
		\item Call any MRI staff; MRI staff call Richard Vega (Siemens Engineer).
		\item Prepare to receive and escort SBFD.
		\item Record issue in ND-HNC Form LG01: Hardware Issues.
	\end{enumerate}
...
\begin{figure}[H]
	...
	\caption{Zone 3 (B15) fire extinguisher location (red arrow).}
	\label{fig:fire-ext}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{mri_fire_extinguisher_1.jpg}
	\caption{Zone 3 (B15) MR-compatible fire extinguisher.}
	\label{fig:fire-ext-mri1}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Control Room oxygen sensor (left) and psychophysiologic equipment (right).}
	\label{fig:oxygen}
\end{figure}
