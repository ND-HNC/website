...
\section{Summary}
This document establishes procedures for Incident and Adverse Event reporting at the Notre Dame Human Neuroimaging Center (ND-HNC). They are intended to match the Incident or Adverse Event with the entity to which reports are made.
...
The ND-HNC follows all guidelines and reporting measures set in place by the University of Notre Dame's Incident Reporting and Management Program from the Risk Management and Safety Department (\href{https://riskmanagement.nd.edu/incident-reporting-management/}{link}).
...
Incidents related to the MRI scanner are reported to: (1) the University, (2) the FDA, and (3) the Manufacturer (Siemens)\cite{medrep}. These guidelines do not overrule, offset, or replace the required reporting of Adverse Events for research teams or investigators.
...
\begin{enumerate}
	\item Call Siemens Healthineers: 1-800-888-7436\cite{siemens}.
\end{enumerate}
