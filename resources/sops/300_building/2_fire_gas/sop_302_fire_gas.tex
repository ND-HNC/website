...
\fancyfoot[C]{}
\fancyfoot[L]{ND-HNC SOP 302: v.0.1.0}
...
\begin{enumerate}
	\item South staff entrance.
    \item (The staff breakroom (B25)).
    \item Outside B21 the Neuro Prep Room.
    \item Across from the elevator bay in the reception area.
    \item Laundry room near the loading dock.
    \item (There is also a fire extinguisher in MRI Zone 3 (B15).)
\end{enumerate}
...
\begin{enumerate}
    \item North and south stairwells
    \item South staff entrance
    \item Loading dock doors
\end{enumerate}
...
\begin{enumerate}
	\item Pull the nearest fire alarm.
	\item Call 911 to notify the South Bend Fire Department (SBFD) and say: ``We have [fire, smoke, gas] in the MRI Center at B05 Veldman Family Psychology Clinic, 501 North Hill Street''.
	\item For small fires, fight fire only if:
	\begin{enumerate}
        \item The Fire Department has been notified
        \item The fire is small and not spreading to other areas
    ...
    \end{enumerate}
    \item Gather in the designated Safe Meeting Spot: north-west corner of parking lot (Fig. \ref{fig:vfpc-rend})
...
\begin{figure}[H]
	...
	\caption{VFPC fire extinguishers and alarm pulls.}
