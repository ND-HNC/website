...
Research personnel may notice something unusual during the normal acquisition, review, or use of the research data. When an unexpected observation occurs:
...
\begin{itemize}
    ...
    \item The clinician sends their review and recommendations to the director (Aron Barbey: abarbey@nd.edu) and MRI technologist (Jeff Fox: jfox22@nd.edu).
\end{itemize}
...
\begin{itemize}
    \item The PI schedules a meeting with the participant to share the clinician's report, referencing the following script:
    \begin{enumerate}
        ...
        \item Provide the radiologists review and recommendation.
        \item Conclude with ``I am not a physician, so it is not appropriate for me to answer any questions about the radiologist's report or provide any advice.''
    \end{enumerate}
