...
\section{Summary}
On rare occasions MRI research personnel may identify neurologic idiosyncracies, termed an `unexpected finding', in data collected at the Notre Dame Human Neuroimaging Center (ND-HNC). This document establishes procedures for responding to such unexpected findings.
...
\begin{itemize}
    ...
    \item The PI is contacted about the unexpected finding. The PI then coordinates with the MRI technologist for an External Review.
    \item The individual is not informed that the escalation process started.
\end{itemize}


\subsection{External Review}
The ND-HNC contracts with Radiology Inc.\cite{radinc} for clinical review of unexpected findings. When a PI contacts ND-HNC staff to initiate an External Review:
