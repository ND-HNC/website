...
\begin{itemize}
    \item The MRI technologist copies the participant structural DICOM files to an encrypted flash drive. These DICOM files do not contain any Patient Health Information or identifiable information.
