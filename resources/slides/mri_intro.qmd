...
::::: columns
:::: {.column width="50%" style="font-size: 65%;"}
- Rarely due to equipment malfunction, usually due to:
    - How equipment is used, and/or
    - Breakdown in following procedure and policy.
- Remedy, design policies that address:
...
[ONLY]{style="color: red;"} when there is:

- a risk to [LIFE/SERIOUS INJURY]{style="color: red;"}, or
- an [UNCONTROLLABLE FIRE]{style="color: red;"} in the MRI room that requires professional firefighting equipment.
