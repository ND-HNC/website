...
![](../media/nmr_2.jpg){.fragment .fade-in-then-out fig-align="right"}

![](../media/t1_1.png){.fragment .fade-in-then-out fig-align="right"}
...
![](../media/tesla_1.png){fig-align="right"}
...
![](../media/cold_1.png){.fragment .fade-in-then-out fig-align="right"}

![](../media/coil_3.png){.fragment .fade-in-then-out fig-align="right"}

![](../media/coil_2.jpg){.fragment .fade-in-then-out fig-align="right"}

![](../media/coil_1.png){.fragment .fade-in-then-out fig-align="right"}
...
![](../media/zones_2.png){.fragment .fade-in-then-out fig-align="right"}

![](../media/zones_1.png){.fragment .fade-in-then-out fig-align="right"}
...
::::: columns
:::: {.column width="50%" style="font-size: 65%;"}
- Everyone who enters Zone 3 **MUST** fill out an [MRI Safety Screener](../media/form_RO01_mri_screen.pdf){target="_blank"}.
...
ND-HNC zone [map](../media/nd-hnc_layout_zones.png){target="_blank"}.
...
![](../media//nd-hnc_layout_zones.png){fig-align="right"}
...
![](../media/reset.png){fig-align="right"}
